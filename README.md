...
```bash
$ pip install logreg_project_prep
```

TODO: Add a brief example of how to use the package to this section

To use logreg_project_prep in your code:

```python
>>> import logreg_project_prep
>>> logreg_project_prep.hello_world()
```

## Copyright

- Copyright © 2026 Renata Lovette, Aidan Aimy, Adrian Chan, Yujia Huang.
